...
7.5/10 This game was pretty funny, I liked the various types of little guys you could become playing this game. The soundtrack was really something special, I would call it a real classic of the genre. In general this game had a sort of flash game to it: you are placed into a mostly flat level with various little critters and you eat them until you get enough points to "evolve" (i.e. buy items at the shop, or whatever).

The gameplay is super repetitive, and it veers into a bit of a weird direction by the end. It was a pretty short game, where you mostly just grind until the next stage. But in spite of it all, I was pretty charmed by it. It was fun! In the sort of very simple way, you know, that "okay" games often are like sometimes. Pretty good!
