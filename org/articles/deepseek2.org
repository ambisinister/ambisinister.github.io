...
2. If you perform SFT in addition to this, you can influence the thought traces to be more human-readable and more frequently mono-linguial, which they use to create a model on par with OpenAI-o1-1217 (DeepSeek-R1)
