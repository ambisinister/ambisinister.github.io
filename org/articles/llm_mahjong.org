...
| Learning rate       | 3e-4                        |
| LR schedule         | linear                      |
| Batch size          | min(48, num_examples // 4)  |
| Max sequence length | 2048                        |
| Number of epochs    | 1                           |
| Eval every          | 50 steps                    |

Partway through training I realized I probably didn't have enough compute credits to complete the project. So I decided I would just go until I ran out of credits and see where we landed.
