...
On page 251 they give an example of differential semi-gradient Sarsa. Semi-gradient Q-learning would jus be this algorithm, but replacing
...
*** (In Progress) 11 - Off-policy Methods with Approximation
