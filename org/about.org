...
therefore always subject to change. What works best for me is if I
keep all of these thoughts in a large collection of plaintext files on
my computer, and automatically generate the website from these
files[fn:2].

As this website has grown, it has become increasingly necessary to
maintain a space for less polished, "work-in-progress" type
writing. These writings can be found on the [[https://planetbanatt.net/blog/index.html][blog]] section of the
website. The boundary is a bit hazy for works which existed prior to
this section's creation, but works on the homepage can roughly be
thought of as "projects" and works on the blog can be thought of as
"things I am working on," with the intent that some posts could
undergo editing and "graduate" to the homepage[fn:3].
...
[fn:3] In general, I dislike blogs; I want my writings to be easily revisitable in 5/10/20 years, and I want to feel comfortable making small edits to various projects on this website after "publication" of the post. The best way to overcome the feeling of "is this finished enough to be posted" is to view all of your projects as perpetual drafts, and to never worry about it. The blog corner of this website grew out of my increasing frustration with microblogging platforms, which I used to enjoy using to capture stray, half-formed thoughts. I no longer feel this way, so a blog it is. 
